...
X_Divisoria: .word 8 # Divisão pra linha cinza
...
Loop_Y:
    ...
    Loop_X:
        ...
        lw $t7, preto        # Guarda em $t7 a cor preta
...
Linhas_Coloridas: 
    ...
    li $a0, 5              # Y_ALTURA = 5
    li $a1, 12             # X_INICIO = 12
    li $a2, 13             # X_FIM = 13
    li $a3, 0x00FFFF00     # Cor amarela
    jal Desenha_Linha_Horizontal           # Chama a sub-rotina de desenho
    
    li $a0, 7              # Y_ALTURA = 7
    li $a1, 10             # X_INICIO = 10
    li $a2, 11             # X_FIM = 11
    li $a3, 0x005353ec     # Cor azul escuro
    jal Desenha_Linha_Horizontal           # Chama a sub-rotina de desenho
    ...
    li $a0, 15             # Y_ALTURA = 15
    li $a1, 16             # X_INICIO = 16
    li $a2, 16             # X_FIM = 16
    li $a3, 0x005353ec     # Cor azul escura
    jal Desenha_Linha_Horizontal           # Chama a sub-rotina de desenho
    
    li $a0, 17             # Y_ALTURA = 17
    li $a1, 14             # X_INICIO = 14
    li $a2, 15             # X_FIM = 15
    li $a3, 0x005353ec     # Cor azul escura
    jal Desenha_Linha_Horizontal           # Chama a sub-rotina de desenho
    
    li $a0, 17             # Y_ALTURA = 17
    li $a1, 17             # X_INICIO = 17
    li $a2, 17             # X_FIM = 17
    li $a3, 0x005353ec     # Cor azul escura
    jal Desenha_Linha_Horizontal           # Chama a sub-rotina de desenho
    ...
    li $a0, 0              # Y_ALTURA = 0
    li $a1, 29             # X_INICIO = 29
    li $a2, 29             # X_FIM = 29
    li $a3, 0x00D3D3D3     # Cor cinza claro
    jal Desenha_Linha_Horizontal           # Chama a sub-rotina de desenho
    
    li $a0, 0              # Y_ALTURA = 0
    li $a1, 30             # X_INICIO = 30
    li $a2, 31             # X_FIM = 31
